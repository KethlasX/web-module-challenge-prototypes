...
/* 
  ...
  1. window binding - when none of the other rules apply, this will return the window or global objnect in node or undefined in strict mode
  2. implicit binding - when the function is invoked look to the left of the dot that's what this refers to
  3. explicit binding - .call, .apply, .bind
  4. new binding - when an object ois created as a constructor this points to the newly created object
*/
